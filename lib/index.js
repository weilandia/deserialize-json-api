...
/* harmony import */ var _mapRelationships__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
var deserializeIncluded = function deserializeIncluded(rel, included) {
  ...
  return _objectSpread({}, rel, Object(_flattenAttributes__WEBPACK_IMPORTED_MODULE_0__["flattenAttributes"])(resource));
};
...
var mapRelationships = function mapRelationships(resource, included) {
  ...
  for (var key in relationships) {
    ...
    if (relData && Array.isArray(relData)) {
      deserializedRel = relData.map(function (rel) {
        return deserializeIncluded(rel, included);
      });
    } else if (relData) {
